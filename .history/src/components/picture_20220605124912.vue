<template>
  <div class="block">
  <div class="block1">
    <span class="demonstration">1.输入图像</span>
  ...
  <div class="block2">
    <span class="demonstration">4.图像滤波</span>
    <el-image :src="filter_photo"></el-image>
  </div>
</div>
</template>
...
export default {
    ...
    data() {
      return {
        ...
        filter_photo: 'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg',
      }
    },
    mounted(){
      bus.$on('result', (data) => {
