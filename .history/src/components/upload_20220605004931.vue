...
<div class="'upload'">
  ...
  >
    ...
    <el-button style="margin-left: 10px;" size="small" type="success" @click="getresult">获取结果</el-button>
...
export default {
  ...
  methods: {
    ...
    getresult(id){
      axios.get('http://127.0.0.1:8000/api/show_context', {
        params: {
         ID: id
        }
      })
    .then(function (response) {
      ...
      this.Imgresult = response.data.result;
    })
